...
public class ScaleFreeGraphGeneratorFactory<V, E> extends GraphGeneratorFactory<V, E, V> {
	@Override
	...
	protected GraphGenerator<V, E, V> createGeneratorImpl(Integer... parameter) {
		return new ScaleFreeGraphGenerator<>(parameter[0]);
	}
	
	@Override
	public String toString() {
		return "Scale-Free Graph Generator";
	}
}
